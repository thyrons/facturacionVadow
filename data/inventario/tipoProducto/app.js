app.controller("tipoProductoController", function ($scope, $state, $http, AuthenticationService,cargarMenuService){
	var token;
    ...
    jQuery(function($) {            
        ...
        $(window).on('resize.jqGrid', function () {
            $(grid_selector).jqGrid('setGridWidth', $("#tabTipoProducto").width() - 10);
        });
        ...
        jQuery(grid_selector).jqGrid({
            url: 'data/inventario/tipoProducto/xml_tipoProducto.php',
            autoencode: false,
            datatype: "xml",
            height: 200,
            ...
            editurl: "data/inventario/tipoProducto/app.php",                
        });
