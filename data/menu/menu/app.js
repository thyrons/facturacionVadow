app.controller("menuController", function ($scope, $state, $http, AuthenticationService,cargarMenuService){
	var token;
    ...
    jQuery(function($) {                
        ...
        jQuery(grid_selector).jqGrid({
            url: 'data/menu/menu/appXml.php',
            autoencode: false,
            datatype: "xml",
            height: 320,
            colNames:['ID','NOMBRE MENU','NOMBRE','ICONO','ESTADO'],
            colModel:[
                {name:'id',index:'id', frozen:true, search:false, editable: true, hidden: true, editoptions: {readonly: 'readonly'}},
            ...
            editurl: "data/menu/menu/app.php",                
        });
