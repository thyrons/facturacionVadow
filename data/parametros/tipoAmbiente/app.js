app.controller("tipoAmbienteController", function ($scope, $state, $http, AuthenticationService,cargarMenuService){
	var token;
    ...
    jQuery(function($) {            
        ...
        $(window).on('resize.jqGrid', function () {
            $(grid_selector).jqGrid('setGridWidth', $("#tabTipoAmbiente").width() - 10);
        });
        ...
        jQuery(grid_selector).jqGrid({
            url: 'data/parametros/tipoAmbiente/xml_tipoAmbiente.php',
            autoencode: false,
            datatype: "xml",
            height: 200,
            ...
            editurl: "data/parametros/tipoAmbiente/app.php",                
        });
