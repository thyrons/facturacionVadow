app.controller("tipoComprobanteController", function ($scope, $state, $http, AuthenticationService,cargarMenuService){
	var token;
    ...
    jQuery(function($) {            
        $( "#tabTipoComprobante" ).click(function( event ) {
        ...
        $(window).on('resize.jqGrid', function () {
            $(grid_selector).jqGrid('setGridWidth', $("#tabTipoComprobante").width() - 10);
        });
        ...
        jQuery(grid_selector).jqGrid({
            url: 'data/parametros/tipoComprobante/xml_tipoComprobante.php',
            autoencode: false,
            datatype: "xml",
            height: 200,
            ...
            editurl: "data/parametros/tipoComprobante/app.php",                
        });
