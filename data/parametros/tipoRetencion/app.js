app.controller("tipoRetencionController", function ($scope, $state, $http, AuthenticationService,cargarMenuService){
	var token;
    ...
    jQuery(function($) {            
        $( "#tabTipoRetencion" ).click(function( event ) {
        ...
        $(window).on('resize.jqGrid', function () {
            $(grid_selector).jqGrid('setGridWidth', $("#tabTipoRetencion").width() - 10);
        });
        ...
        jQuery(grid_selector).jqGrid({
            url: 'data/parametros/tipoRetencion/xml_tipoRetencion.php',
            autoencode: false,
            datatype: "xml",
            height: 200,
            ...
            editurl: "data/parametros/tipoRetencion/app.php",                
        });
