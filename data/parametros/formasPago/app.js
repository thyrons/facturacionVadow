app.controller("formasPagoController", function ($scope, $state, $http, AuthenticationService,cargarMenuService){
	var token;
    ...
    jQuery(function($) {            
        $( "#tabFormasPago" ).click(function( event ) {
        ...
        $(window).on('resize.jqGrid', function () {
            $(grid_selector).jqGrid('setGridWidth', $("#tabFormasPago").width() - 10);
        });
        ...
        jQuery(grid_selector).jqGrid({
            url: 'data/parametros/formasPago/xml_formasPago.php',
            autoencode: false,
            datatype: "xml",
            height: 200,
            colNames:['ID','CÓDIGO','NOMBRE','ESTADO','MONEDA','TIEMPO'],
            colModel:[
                ...
                {name:'moneda',index:'moneda',width:150, editable:true, editoptions:{size:"20", maxlength:"150"}, editrules: {required: true}},
                {name:'tiempo',index:'tiempo',width:150, editable:true, editoptions:{size:"20", maxlength:"150"}, editrules: {required: true}},
            ...
            editurl: "data/parametros/formasPago/app.php",                
        });
