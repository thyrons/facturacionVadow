app.controller("tipoImpuestoController", function ($scope, $state, $http, AuthenticationService,cargarMenuService){
	var token;
    ...
    jQuery(function($) {            
        $( "#tabTipoImpuesto" ).click(function( event ) {
        ...
        $(window).on('resize.jqGrid', function () {
            $(grid_selector).jqGrid('setGridWidth', $("#tabTipoImpuesto").width() - 10);
        });
        ...
        jQuery(grid_selector).jqGrid({
            url: 'data/parametros/tipoImpuesto/xml_tipoImpuesto.php',
            autoencode: false,
            datatype: "xml",
            height: 200,
            ...
            editurl: "data/parametros/tipoImpuesto/app.php",                
        });
