app.controller("tipoEmisionController", function ($scope, $state, $http, AuthenticationService,cargarMenuService){
	var token;
    ...
    jQuery(function($) {            
        $( "#tabTipoEmision" ).click(function( event ) {
        ...
        $(window).on('resize.jqGrid', function () {
            $(grid_selector).jqGrid('setGridWidth', $("#tabTipoEmision").width() - 10);
        });
        ...
        jQuery(grid_selector).jqGrid({
            url: 'data/parametros/tipoEmision/xml_tipoEmision.php',
            autoencode: false,
            datatype: "xml",
            height: 200,
            ...
            editurl: "data/parametros/tipoEmision/app.php",                
        });
